                     ...
                     <table class="table table-responsive-md">
                         <thead>
                             ...
                             <tr style="font-size:20px;font-weight:bolder">
                                 ...
                                 <th class="text-center">
                                     <a class="text-white text-right" href="{{route('manage_users.create')}}"><button class="btn ml-4 btn-success" style="width: 150px">add</button></a>
                                 </th>
                               </tr>
                         </thead>
                         <tbody>
                             ...
                             <tr>
                               ...
                               <td class="text-center">
                                 <a href="{{route('manage_users.edit', $user->id)}}"><button type="button" class="btn btn-primary btn-sm">edit</button></a>
                                 <form style="display: inline-block" action="{{route('manage_users.destroy',$user->id)}}" method="POST">
                                   @csrf
                                   @method("delete")
