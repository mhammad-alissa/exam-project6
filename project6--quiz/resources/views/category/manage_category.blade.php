                    ...
                    <table class="table table-responsive-md">
                        <thead>
                            ...
                            <tr style="font-size:20px;font-weight:bolder">
                                ...
                                <th class="text-center">
                                    <a class="text-white text-right" href="{{route('manage_categories.create')}}"><button class="btn ml-4 btn-success" style="width: 150px">add</button></a>
                                </th>
                              </tr>
                        </thead>
                        <tbody>
                            ...
                            <td>mmmmmmmmmmm</td>
                              ...
                              <td class="text-center" style="max-width:220px">
                               {{-- {{$category->category_description}} --}}
                            <img width="55" src="{{asset('/black/img/'.$category->category_image) }}" alt="">
                              </td>
                              <td class="text-center">
                                {{$category->created_at}}
                              </td>
                              <td class="text-center">
                                <a href="{{route('manage_categories.edit', $category->category_id)}}"><button type="button" class="btn btn-primary btn-sm">edit</button></a>
                                <form style="display: inline-block" action="{{route('manage_categories.destroy',$category->category_id)}}" method="POST">
                                  @csrf
                                  @method("delete")
